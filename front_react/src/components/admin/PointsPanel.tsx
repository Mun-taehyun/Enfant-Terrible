...
import type {
  ...
  AdminPointHistorySortBy,
  AdminPointHistoryDirection,
} from "@/types/admin/point";
import {
  useAdminPointAdjust,
  useAdminPointBalance,
  useAdminPointHistory,
} from "@/hooks/admin/adminPoint.hook";
          ...
          <div className={styles.adjustBody}>
            <div className={styles.formWrap}>
              <div className={styles.formRow}>
                <label className={styles.label}>포인트 조정</label>
                <input
              ...
              <div className={styles.formRow}>
                <label className={styles.label}>발생 경로</label>
                <input
                  className={styles.input}
                  value={refType}
                  onChange={(e) => setRefType(e.target.value)}
                  placeholder="예: 주문 / 이벤트"
                />
              </div>
          ...
          <div className={styles.historyBody}>
            <div className={styles.toolbar}>
              <div className={styles.toolItem}>
                <span className={styles.toolLabel}>정렬 기준</span>
                <select
                ...
                >
                  <option value="POINT_HISTORY_ID">최신순</option>
                  <option value="CREATED_AT">발생일시</option>
                </select>
              </div>

              <div className={styles.toolItem}>
                <span className={styles.toolLabel}>정렬 방향</span>
                <select
                  className={styles.select}
                  value={direction}
                  onChange={(e) => {
              ...
              <div className={styles.toolItem}>
                <span className={styles.toolLabel}>페이지 크기</span>
                <select
                  className={styles.select}
                  value={size}
                  onChange={(e) => {
            ...
            {hist.isPending ? (
              ...
              <>
                <div className={styles.meta}>총 {totalCount.toLocaleString()}건</div>
