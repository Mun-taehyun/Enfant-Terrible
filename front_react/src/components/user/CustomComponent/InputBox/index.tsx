...
const InputBox = forwardRef<HTMLInputElement, Props> ((props: Props, ref) => {
    ...
    const {label, type, placeholder,name, value , error , message, buttonName } = props;
    ...
    return (
        <div className='inputbox'>
            ...
            <div className={error ? 'inputbox-container-error' : 'inputbox-container'}>
                <input ref={ref} type={type} className='input' placeholder={placeholder} name={name} value={value} onChange = {onChange} onKeyDown={onKeyDownHandler}/>
                {onButtonClick !== undefined && (
                <button className='custom-submit-button' onClick={onButtonClick}>
                    {/* 아이콘 대신 텍스트를 넣거나, 아이콘이 있을 때만 출력 */}
