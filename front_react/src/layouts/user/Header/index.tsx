...
import { AUTH_LOGIN_PATH, AUTH_PATH, CART_PATH, MAIN_PATH,POST_PATH,USER_PATH } from "@/constant/user/route.index";
...
export default function Header() {
    ...
    //이벤트핸들러 : 메인 버튼 클릭 이벤트 처리 
    const onMainButtonClickEventHandler = () => {
        navigate(MAIN_PATH());
    }
    ...
    //이벤트핸들러 : 공지사항 버튼 클릭 이벤트 처리
    const onClickNoticeEventHandler = () => {
        navigate(POST_PATH());
    }
...
//=====================================  검색 내부 컴포넌트 ==============================
    ...
    const SearchButton = () => {
        ...
        const onSearchKeyDownEventHandler = (event: KeyboardEvent<HTMLInputElement>) => {
            if (event.key !== "Enter" || event.currentTarget.value === null) return;
            updateSearchFilter({
        ...
        return (
            <div className='header-search-input-box'>
                ...
                <div ref={searchButtonRef} className='search-action-button' onClick={onSearchButtonClickHandler}>
    ...
    return (
       <div id="header-container">
            <div className="header-main-box">
                <div className="header-main-logo-box" onClick={onMainButtonClickEventHandler}>
                    <div className="header-logo-content">{'앙팡테리블'}</div>
                </div>
                <SearchButton />
                <div className="header-main-post-box">
                    <div className='search-action-button' onClick={onClickNoticeEventHandler}>
                        <span className="button-label">공지사항</span>
                    </div>
                </div>
                {token !== null ?
